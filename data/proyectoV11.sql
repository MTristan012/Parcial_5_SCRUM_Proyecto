...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-07-2023 a las 20:29:49
...
--
-- Estructura de tabla para la tabla `universityusersassigments`
--

CREATE TABLE `universityusersassigments` (
  `id` int(200) NOT NULL,
  `materia` varchar(200) NOT NULL,
  `tarea` longblob NOT NULL,
  `examen` longblob NOT NULL,
  `nombreAlumno` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `universityusersassigments`
--
ALTER TABLE `universityusersassigments`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `universityusersassigments`
--
ALTER TABLE `universityusersassigments`
  MODIFY `id` int(200) NOT NULL AUTO_INCREMENT;
COMMIT;
